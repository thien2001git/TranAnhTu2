...
const tinh = [
  ...
  {id:16,name:'Lào Cai'},
  {id:17,name:'Yên Bái'},
  {id:18,name:'Thái Nguyên'},
  {id:19,name:'Lạng Sơn'},
  {id:20,name:'Bắc Giang'},
  {id:21,name:'Phú Thọ'},
  {id:22,name:'Điện Biên'},
  {id:23,name:'Lai Châu'},
  {id:24,name:'Sơn La'},
  {id:25,name:'Hoà Bình'},
  {id:26,name:'Thanh Hoá'},
  {id:27,name:'Nghệ An'},
  {id:28,name:'Hà Tĩnh'},
...
const Checkout = (props) => {
  ...
  const onLoadDistrictHandler = (id) => {
    ...
    for (let i = 0; i < huyen.data.nItems; i++) {
      ...
      if(it.path.includes(resp.name)) {
        listHuyen.push({
          id: it.code,
          name: it.name_with_type,
          data: it
        })
      }
    }
    setDistrict(listHuyen)
  };
  ...
  const onLoadWardHandler = (id) => {
    ...
    for (let i = 0; i < xa.data.nItems; i++) {
      ...
      if(it.path_with_type.includes(_huyen.data.path_with_type)) {
        listXa.push({
          id: it.code,
          name: it.name_with_type,
          data: it
  ...
  const onSubmitHandler = (data) => {
    ...
    var _district = JSON.parse(data.district)
